...
echo 'Cuadrado -> lado: ' . $ladoCuadrado . ', área: ' . $areaCuadrado . ', perímetro: ' . $perimetroCuadrado . '<br>';
...
echo 'Triángulo -> base: ' . $baseTriangulo . ', altura: ' . $alturaTriangulo . ', área: ' . $areaTriangulo . ', perímetro: ' . $perimetroTriangulo . '<br>';
...
echo 'Rectángulo -> base: ' . $baseRectangulo . ', altura: ' . $alturaRectangulo . ', área: ' . $areaRectangulo . ', perímetro: ' . $perimetroRectangulo . '<br>';
